    ...
    return (
        <div className='lg:sectionContainer relative'>
            ...
            <div className='flex flex-col lg:flex-row'>
                ...
                <p className='text-neutral-400 flex-1 tracking-wide'>
                    I’m a software engineer specializing in designing and building full
                    stack applications. I translate valuable data insights into
                    functinally beautiful applications. I was recently focused on building
                    an IoT and cloud coworking platform at Last Lock. Now, currently am
                    looking for new opportunities.
                    <br /> <br />
                    I'm a full stack engineer who translates data insights into valuable
